...
public final class BancUtil {
    ...
    public static void ferTraspas(){
        ...
        if(triarCompteClient()){
            ...
            System.out.println("No has triat bé el compte\n");
        }
    }
    /**
    ...
    public static void ferIngres(){
        ...
        if(triarCompteClient()){
            ...
            try{
                ...
                System.out.print("No has introduït una quantitat de diners vàlida");
            }
        }else{
    ...
    public static void retirarEfectiu(){
        ...
        if(triarCompteClient()){
            ...
            try{
                ...
                System.out.println("No has introduït una quantitat vàlida");
            }
    ...
    public static void mostrarTot(){
        ...
        for(Client cli: clients){
            System.out.println("Nom propietari: "+cli.nom+" Edad: "+cli.edat);
        }
        Collections.reverse(comptes);
        for(CompteBancari c: comptes){
            System.out.println("IBAN: "+c.iban+" Nom propietari: "+c.propietari.nom+" Saldo: "+c.saldo);
        }
        Collections.sort(targetes);
        for(Targeta t: targetes){
            System.out.println("Numero targeta: "+t.numeroTarjeta+" Nom propietari: "+t.compte.propietari.nom+" Data caducitat:"+data.format(t.dataCaducitat));
        }
    }
}